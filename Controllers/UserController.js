...
const loginUser = asyncHandler(async (req, res)=>{
    ...
    try {
        ...
        // if user exists compare password with hashed password then
...
const changeUserPassword = asyncHandler(async (req, res)=>{
    ...
    try {
        //find user in DB
        const user = await User.findById(req.user._id)
        // if user exists compare old password with hashed password then
        // update user password and save it in DB
